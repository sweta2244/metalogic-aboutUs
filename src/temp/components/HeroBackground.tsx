    ...
    class Blob {
      ...
      draw() {
        ...
        for (let i = 0; i < 6; i++) {
          ...
          const currentRadius =
            this.radius + Math.sin(Date.now() * 0.001 + i) * variationAmount;
          const nextRadius =
            this.radius +
            Math.sin(Date.now() * 0.001 + i + 1) * variationAmount;
          ...
          const cpX1 =
            this.x + Math.cos(angle + angleStep * 0.3) * currentRadius * 1.2;
          const cpY1 =
            this.y + Math.sin(angle + angleStep * 0.3) * currentRadius * 1.2;

          const cpX2 =
            this.x + Math.cos(nextAngle - angleStep * 0.3) * nextRadius * 1.2;
          const cpY2 =
            this.y + Math.sin(nextAngle - angleStep * 0.3) * nextRadius * 1.2;
